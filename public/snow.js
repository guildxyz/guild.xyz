/**
 * @license ## !!!!!!!!?DHTML Snowstorm! JavaScript-based snow for web pages Making
 *   it snow on the internets since 2003. You're welcome.
 *
 *   Version 1.44.20131208 (Previous rev: 1.44.20131125) Copyright (c) 2007, Scott
 *   Schiller. All rights reserved. Code provided under the BSD License
...
var snowStorm = (function (window, document) {
  ...
  this.snowColor = "var(--chakra-colors-whiteAlpha-700)" // Don't eat (or use?) yellow snow.
  this.snowCharacter = "&bull;" // &bull; = bullet, &middot; is square on some systems etc.
  this.snowStick = true // Whether or not snow should "stick" at the bottom. When off, will never collect.
  this.targetElement = "background" // element which snow will be appended to (null = document.body) - can be an element ID eg. 'myDiv', or a DOM node reference
  ...
  storm.events.add(window, "snow", doContinue, false)
  storm.events.add(window, "stopSnow", doStop, false)
