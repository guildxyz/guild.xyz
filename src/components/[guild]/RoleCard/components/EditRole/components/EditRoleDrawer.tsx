...
import EditRoleFooter from "./EditRoleFooter"
import EditRoleHeader from "./EditRoleHeader"
import EditRolePlatforms from "./EditRolePlatforms"
  ...
  return (
    <>
      ...
      >
        <DrawerOverlay />
        <DrawerContent>
          <DrawerBody className="custom-scrollbar" pb={28}>
