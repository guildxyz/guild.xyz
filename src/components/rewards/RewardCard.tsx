...
export const RewardCard = ({
  ...
  <Card className={cn("@container border-2 p-4 shadow-none", className)}>
    <div className="flex @[18rem]:flex-row flex-col gap-4">
...
export const RewardCardButton = ({
  ...
  <Button
    className={cn("mt-auto @[18rem]:ml-auto", className)}
    size="sm"
    {...props}
  />
);
