  ...
  return (
    <div
      className={cn(
        ...
        {
          "h-16": isNavStuck,
          "h-[calc(theme(space.36)+theme(space.2))] bg-gradient-to-t from-card to-background data-[theme='dark']:from-background data-[theme='dark']:to-card-secondary sm:h-[calc(theme(space.28)-theme(space.2))]":
            isSearchStuck,
        }
      )}
    />
