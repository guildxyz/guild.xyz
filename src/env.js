...
export const env = createEnv({
  server: {
    ...
    CYPRESS_RECORD_KEY: z.string(),
    EDGE_CONFIG: z.string(),
    GOERLI_ALCHEMY_KEY: z.string(),
    GUILD_API_KEY: z.string(),
    IPFS_GATEWAY: z.string(),
    JUICEBOX_API: z.string(),
    JUICEBOX_IPFS: z.string(),
    ...
    POAP_X_API_KEY: z.string(),
    POLYGON_ALCHEMY_KEY: z.string(),
    POLYGON_MUMBAI_ALCHEMY_KEY: z.string(),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_GOOGLE_SERVICE_ACCOUNT_EMAIL: process.env.NEXT_PUBLIC_GOOGLE_SERVICE_ACCOUNT_EMAIL,
    NEXT_PUBLIC_POSTHOG_KEY: process.env.NEXT_PUBLIC_POSTHOG_KEY,
    NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID: process.env.NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID,
    NEXT_PUBLIC_EDGE_CONFIG_ID: process.env.NEXT_PUBLIC_EDGE_CONFIG_ID,
    NEXT_PUBLIC_EDGE_CONFIG_READ_ACCESS_TOKEN: process.env.NEXT_PUBLIC_EDGE_CONFIG_READ_ACCESS_TOKEN,
    ...
    GOERLI_ALCHEMY_KEY: process.env.GOERLI_ALCHEMY_KEY,
    GUILD_API_KEY: process.env.GUILD_API_KEY,
    IPFS_GATEWAY: process.env.IPFS_GATEWAY,
    JUICEBOX_API: process.env.JUICEBOX_API,
    JUICEBOX_IPFS: process.env.JUICEBOX_IPFS,
    ...
    MIRROR_API: process.env.MIRROR_API,
    NACL_PUBLIC: process.env.NACL_PUBLIC,
    ...
    POAP_X_API_KEY: process.env.POAP_X_API_KEY,
    POLYGON_ALCHEMY_KEY: process.env.POLYGON_ALCHEMY_KEY,
    POLYGON_MUMBAI_ALCHEMY_KEY: process.env.POLYGON_MUMBAI_ALCHEMY_KEY,
    ...
    SECRET_WORDS: process.env.SECRET_WORDS,
